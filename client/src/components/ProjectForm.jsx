    ...
    return (
        <div className='space-y-6'>
            <div className='flex items-center justify-between'>
                <div>
                    <h3 className='flex items-center gap-2 text-lg font-semibold text-gray-900'>Projets</h3>
                    ...
                    data.map((project, index) => (
                        <div key={index} className='border p-4 border-gray-200 rounded-lg space-y-3'>
                            ...
                            <div className='grid gap-3'>
                                <input value={project.name || ""} onChange={(e) => updateProject(index, "name", e.target.value)} type="text" placeholder='Projet Name' className='px-3 py-2 text-sm rounded-lg' />
