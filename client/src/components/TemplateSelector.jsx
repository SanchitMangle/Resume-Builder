    ...
    const templates = [
        {
            id: 'classic',
            name: 'Classic',
            preview: 'A clean, traditinoal resume format with clear sections and professional typografy'
        },
        {
            id: 'modern',
            name: 'Modern',
            preview: 'Sleek desing with strategic use of color and modern font choices'
        },
        {
            id: 'minimal-image',
            name: 'Minimal image',
            preview: 'Minimal desing with single image and clean typografy '
        },
        {
            id: 'minimal',
            name: 'Minimal',
    ...
    return (
        <div className='relative'>
            <button onClick={() => setIsOpen(!isOpen)} className='flex items-center gap-1 text-sm text-blue-600 bg-gradient-to-br from-blue-50 to-blue-100 ring-blue-300 hover:ring transition-all px-3 py-2 rounded-lg'>
                <Layout size={14} /> <samp className='max-sm:hidden'>Template</samp>
            </button>
            {
                isOpen && (
