...
const Features = () => {
    ...
    return (
        <div id='features' className='flex flex-col items-center my-10 scroll-mt-12'>
            ...
            <Title title='Build your resume' description='Our streamlined process help you create professional resume in minutes with intelligent Ai-Powered tools and features' />
