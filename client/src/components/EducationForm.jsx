...
const EducationForm = ({ data, onChange }) => {
    ...
    const updateEducation = (index, feild, value) => {
        const updated = [...data];
                            ...
                            data.map((education, index) => (
                                <div key={index} className='border p-4 border-gray-200 rounded-lg space-y-3'>
                                    ...
                                    <div className='grid md:grid-cols-2 gap-3'>
                                        ...
                                        <input value={education.degree || ""} onChange={(e) => updateEducation(index, "degree", e.target.value)} type="text" placeholder='Degree (e.g,Bacholer`s,Master`s)' className='px-3 py-2 text-sm' />

                                        <input value={education.feild || ""} onChange={(e) => updateEducation(index, "feild", e.target.value)} type="text" placeholder='Feild of study' className='px-3 py-2 text-sm ' />
                                    ...
                                    <input value={education.gpa || ""} onChange={(e) => updateEducation(index, "gpa", e.target.value)} type="text" placeholder='GPA (optioal)' className='px-3 py-2 text-sm ' />
                                </div>
                            ))
                        }
                    </div>
