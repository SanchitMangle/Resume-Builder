                ...
                <div className='grid lg:grid-cols-12 gap-8'>
                    ...
                    <div className='relative lg:col-span-5 rounded-lg overflow-hidden'>
                        <div className='bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1'>
                            ...
                            <hr className='absolute top-0 ring-0 left-0 border-2 border-gray-200' />
                    ...
                    <div className='lg:col-span-7 max-lg:mt-6'>
                        <div className='relative w-full'>
                            <div className='absolute bottom-3 left-0 right-0 flex items-center justify-end gap-2'>
                                ...
                                <button onClick={changeResumeVisiblity} className='flex items-center gap-2 px-4 p-2 text-xs bg-gradient-to-br from-purple-100 to-purple-200 text-purple-600 rounded-lg ring-purple-300 hover:ring transition-colors'>
                        ...
                        <ResumePreview data={resumeData} template={resumeData.template} accenetColor={resumeData.accent_color} />
